...
| LaPa            | `2d_106`          | `https://github.com/argiacomi/faceswap-test-dev/blob/master/tools/automask/lapa_adapter.py` | `python tools/build_quality_dataset.py --dataset lapa --source-dir <root> --output-dir runs/landmarks/build_lapa`                                                           |
